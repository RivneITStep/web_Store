#pragma checksum "F:\web_store\web_store\Views\About\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ba13af92df16ef721623a05f87a4bfbffdb803ad"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ba13af92df16ef721623a05f87a4bfbffdb803ad", @"/Views/About/Index.cshtml")]
...
<div class=""container-fluid"">
    <div class=""row"">
        ...
        <div class=""col-md-12"">
            ...
            <p>
                Якщо ви п’єте, і не п’янієте, значить, ваші ферменти алкогольдегідрогенази вправно руйнують алкоголь. Тим часом людина продовжує пити, бо не відчуває сп’яніння і гадає, що все під контролем. Але спирт в печінці стає оцтовим а");
            WriteLiteral(@"льдегідом — сполукою також токсичною для організму. І руйнувати його мають уже інші ферменти, які можуть діяти повільно. Краще “не вміти пити”, тобто мати малоефективні алкогольдегідрогенази і рано спинятися.
            </p>
        </div>
        <div class=""col-md-12"">
        ...
        <div class=""col-md-12"">
            ...
            <p>
                Навпаки. Преса та блоги поширюють міф, начебто кава та алкоголь подовжують життя -— довгожителі п’ють і те, і те. Але це викрив");
            WriteLiteral(@"лення та перекручування інформації. Ровесники століття з чаркою та філіжанкою просто мають хороші гени, та, ймовірно, інші бонуси буття
            </p>
        </div>
        <div class=""col-md-12"">
        ...
        <div class=""col-md-12"">
            ...
            <p>
                У жінок, що страждають на алкоголізм, в мозкові суттєві збільшені ділянки, що відповідають за задоволення та заохочення поведінки. А в чоловіків навпаки. При цьому алкоголь в чоловіків викликає в");
            WriteLiteral(@"двічі більший викид дофаміну (медіатору, що бере участь в заохоченні), ніж в жінок. Цим нині пояснюють більшу поширеність алкоголізму серед чоловіків. Також науковці вважають, що мозок жінок більш вразливий до пошкодження алкоголем.
            </p>
        </div>
        <div class=""col-md-12"">
